    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                ...
                                <option value="price">ordenar por: menor a mayor</option>
                                <option value="price-desc">ordenar por: mayor a menor</option>
                            </select>
                        </div>
                ...
                @else
                <p class="text-danger no-products border border-danger border-rounded">No hay productos</p>
                @endif
