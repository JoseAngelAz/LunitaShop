				...
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					@foreach ($sliders as $slide)
						<div class="item-slide">
							<img src="{{asset('assets/images/sliders')}}/{{$slide->image}}" alt="imagen" class="img-slide">
	...
	<div class="product product-style-2 equal-elem " style="height: 316px;">
						<div class="product-thumnail">
							<a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
								<figure><img src="http://localhost:8000/assets/images/products/digital_18.jpg" width="800" height="800" alt=""></figure>
							</a>
